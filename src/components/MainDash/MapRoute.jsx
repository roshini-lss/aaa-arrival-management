    ...
    async function calculateRoute(coord) {
        ...
        geocoder.geocode({ address: origin }, async (results, status) => {
            if (status === "OK" && results[0]) {
                ...
                const durationText =
                    directionsResults.routes[0].legs[0].duration.text
                ...
                const predictedDurationInSeconds =
                    googleDurationInSeconds + 60 * 20
                ...
                if (
                    legs &&
                    legs.length > 0 &&
                    legs[0].end_address === destination
                ) {
